      ...
      <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-md mx-auto mt-8">
        ...
        {loading && (
          <div className="flex flex-col items-center mt-8 mb-4">
            ...
            <div className="text-blue-600 font-semibold">Tracking...</div>
          </div>
        )}
        {result && (
          <div className="mt-4">
            <div className="mb-4 flex items-center justify-between">
              ...
              {showShare && (
                <div className="share-popover absolute right-0 mt-2 z-50 bg-white border border-gray-200 rounded-lg shadow-lg p-4 min-w-[180px] flex flex-col gap-2 animate-fade-in">
                  <div className="font-bold text-gray-700 mb-2">Share to</div>
                  ...
                  <button className="flex items-center gap-2 px-3 py-2 rounded hover:bg-green-50 text-green-700 font-semibold text-sm" onClick={() => alert('Please manually paste the link in WeChat') }>
        ...
        <div className="mt-8 text-center">
          <span className="text-gray-500 mr-2">Sample order number:</span>
          <span
