...
export const translations = {
  en: {
    ...
    statActiveMerchantsTooltip: 'Only customers with verified monthly billing are counted here.',
    dashboardTitle: 'Dashboard',
    dashboardWelcome: 'Welcome to KAIFA Admin Dashboard',
    ...
    billMarkedAsPaid: 'Bill marked as paid for',
  ...
  zh: {
    ...
    statTotalRevenue: '订单总金额',
    statActiveMerchants: '活跃商户数',
    statActiveMerchantsTooltip: '此处仅统计通过企业月结认证的客户。',
    dashboardTitle: '管理员仪表板',
    dashboardWelcome: '欢迎使用KAIFA管理员仪表板',
    topRoutes: '热门路线',
    ordersLabel: '单',
    revenueLabel: '收入',
    createOrder: '创建订单',
    ...
    businessVerificationDesc: '如需开通月结及其他高级功能，请先提交企业认证。',
    ...
    monthlyBillingNotAvailableDesc: '请先提交企业认证以开通月结功能。',
    ...
    resetFilters: '重置筛选',
    noInvoices: '无账单',
    noInvoicesDescription: '没有符合筛选条件的账单。',
    billingAndInvoices: '账单与发票',
    recentInvoices: '最近账单',
    pendingInvoices: '待付账单',
    nextDueDate: '下次到期日',
    noUpcomingDue: '无待付账单',
    viewInvoice: '查看发票',
