...
export const translations = {
  ...
  it: {
    ...
    viewDetails: 'View Details',
    // PDF/打印模板相关
    orderDetailsReport: 'Ordine Dettagli Report',
    orderIdLabel: 'Ordine ID:',
    statusLabel: 'Stato:',
    packageCountLabel: 'Numero Pacchi:',
    recipientLabel: 'Destinatario:',
    senderLabel: 'Mittente:',
    summaryLabel: 'Sommario:',
    generatedLabel: 'Generato:',
    scanBarcode: 'Scansiona il Codice a Barre per Tracciare',
    scanToTrack: 'Scansiona per tracciare questo ordine',
    generatedBy: 'Questo documento è stato generato dalla piattaforma di logistica KAIFA EXPRESS',
    contactSupport: 'Per qualsiasi domanda, contatta il nostro team di supporto',
    // 登录快捷提示
    quickLoginTips: '💡 Quick Login Tips:',
    quickLoginTip1: '• Click the email field to see saved accounts',
    quickLoginTip2: '• Select any account to auto-fill credentials',
