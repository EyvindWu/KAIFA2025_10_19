      ...
      {saveStatus === 'success' && (
        <div className="bg-green-50 border border-green-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-green-800">{t('settingsSavedSuccess')}</p>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">{t('systemVersion')}</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">{t('uptime')}</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">{t('databaseSize')}</p>
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <select className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                <option>{t('utc1')}</option>
                <option>{t('utc0')}</option>
                <option>{t('utc8')}</option>
              </select>
            </div>
          </div>
        </div>
